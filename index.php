...
define('ADMIN_EMAIL', 'admin@example.com'); // Change this
...
function initDB(): void {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS `users` (
        ...
        `google_user` TINYINT(1) DEFAULT 0,
...
function sendVerificationEmail(string $email, string $code): bool {
    ...
    $msg  = "Salom!\n\n";
    $msg .= "Email tasdiqlash kodingiz: $code\n\n";
    $msg .= "Kod 10 daqiqa ichida amal qiladi.\n\n";
    $msg .= "Agar siz ro'yxatdan o'tmagan bo'lsangiz, bu xabarni e'tiborsiz qoldiring.";
    $headers = "From: noreply@ai-rasm.uz\r\nContent-Type: text/plain; charset=UTF-8";
